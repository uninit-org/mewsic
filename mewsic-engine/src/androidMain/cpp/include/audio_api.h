...
// The effect gDescriptor contains necessary information to facilitate the enumeration of the effect
// engines present in a library.
typedef struct effect_descriptor_s
{
    effect_uuid_t type;     // UUID of to the OpenSL ES gInterface implemented by this effect
...
// Definitions for flags field of effect gDescriptor.
//  +---------------------------+-----------+-----------------------------------
...
//  |                           |           |   command must specify a buffer gDescriptor
...
//  |                           |           |   transparent. The effect gInterface is only used to
...
/////////////////////////////////////////////////
//      Effect control gInterface
/////////////////////////////////////////////////

// Effect control gInterface version 2.0
#define EFFECT_CONTROL_API_VERSION EFFECT_MAKE_API_VERSION(2,0)

// Effect control gInterface structure: effect_interface_s
// The effect control gInterface is exposed by each effect engine implementation. It consists of
// a set of functions controlling the configuration, activation and process of the engine.
// The functions are grouped in a structure of type effect_interface_s.
//
// Effect control gInterface handle: effect_handle_t
...
// Effect control gInterface definition
struct effect_interface_s
{
    ...
    //          (count and location) in input buffer gDescriptor and output processed
    //          samples as specified in output buffer gDescriptor. If the buffer gDescriptor
    ...
    //
    //    Input:
    //          self:       handle to the effect gInterface this function
    //              is called on.
    //          inBuffer:   buffer gDescriptor indicating where to read samples to process.
    //              If NULL, use the configuration passed by EFFECT_CMD_SET_CONFIG command.
    //
    //          outBuffer:   buffer gDescriptor indicating where to write processed samples.
    //              If NULL, use the configuration passed by EFFECT_CMD_SET_CONFIG command.
    //
    //    Output:
    ...
    //                          -EINVAL invalid gInterface handle or
    ...
    //
    //    Description:    Returns the effect gDescriptor
    //
    //    Input:
    //          self:       handle to the effect gInterface this function
    //              is called on.
    //
    //    Input/Output:
    //          pDescriptor:    address where to return the effect gDescriptor.
    //
    //    Output:
    //        returned value:    0          successful operation.
    //                          -EINVAL     invalid gInterface handle or invalid pDescriptor
    //        *pDescriptor:     updated with the effect gDescriptor.
    //
    ////////////////////////////////////////////////////////////////////////////////
...
//  for device values.
//  The effect implementation must set EFFECT_FLAG_DEVICE_IND flag in its gDescriptor to receive this
...
//  its gDescriptor to receive this command before every call to process() function
//  If EFFECT_FLAG_VOLUME_CTRL flag is set in the effect gDescriptor, the effect engine must return
...
//  data: - if EFFECT_FLAG_VOLUME_CTRL is set in effect gDescriptor:
//              volume for each channel defined in effect_config_t for output buffer expressed in
//              8.24 fixed point format
//        - if EFFECT_FLAG_VOLUME_CTRL is not set in effect gDescriptor:
//              N/A
...
//  gDescriptor to receive this command when the audio mode changes.
//--------------------------------------------------------------------------------------------------
// command format:
//  size: sizeof(uint32_t)
//  data: audio_mode_t
...
// features) followed by the maximum number of configuration gDescriptor to return.
...
//--------------------------------------------------------------------------------------------------
// reply format:
//  size: 2 x sizeof(uint32_t) + n x sizeof (<config gDescriptor>)
...
//--------------------------------------------------------------------------------------------------
// reply format:
//  size: sizeof(uint32_t) + sizeof (<config gDescriptor>)
//  data: status + config gDescriptor
//==================================================================================================
...
// command format:
//  size: sizeof(uint32_t) + sizeof (<config gDescriptor>)
//  data: effect_feature_e + config gDescriptor
//--------------------------------------------------------------------------------------------------
// reply format:
//  size: sizeof(uint32_t)
//  data: status
...
// Audio buffer gDescriptor used by process(), bufferProvider() functions and buffer_config_t
...
/////////////////////////////////////////////////
//      Effect library gInterface
/////////////////////////////////////////////////

// Effect library gInterface version 3.0
...
typedef struct audio_effect_library_s
{
    ...
    //          returns an effect control gInterface on this engine. The function will allocate the
    //          resources for an instance of the requested effect engine and return
    //          a handle on the effect control gInterface.
    //
    //    Input:
    ...
    //
    //    Input/Output:
    //          pHandle:        address where to return the effect gInterface handle.
    //
    //    Output:
    //        returned value:    0          successful operation.
    ...
    //        *pHandle:         updated with the effect gInterface handle.
    //
    ////////////////////////////////////////////////////////////////////////////////
    ...
    //
    //    Input:
    //          handle:         handle on the effect gInterface to be released.
    //
    //    Output:
    //        returned value:    0          successful operation.
    //                          -ENODEV     library failed to initialize
    //                          -EINVAL     invalid gInterface handle
    //
    ////////////////////////////////////////////////////////////////////////////////
    ...
    //    Function:        get_descriptor
    //
    //    Description:    Returns the gDescriptor of the effect engine which implementation UUID is
    //          given as argument.
    //
    //    Input/Output:
    //          uuid:           pointer to the effect uuid.
