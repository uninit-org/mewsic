...
internal class HFAdjustment : Constants, NoiseTable {
    ...
    companion object {
        ...
        fun hf_adjustment(sbr: SBR, Xsbr: Array<Array<FloatArray>>, ch: Int): Int {
        ...
        private fun get_S_mapped(sbr: SBR, ch: Int, l: Int, current_band: Int): Int {
...
//                        Arrays.arraycopy(adj.Q_M_lim_boost[l], 0, sbr.Q_temp_prev.get(ch).get(n), 0, sbr.M)
        ...
        private fun calculate_gain(sbr: SBR, adj: HFAdjustment, ch: Int) {
            var m: Int
            var l: Int
            var k: Int
