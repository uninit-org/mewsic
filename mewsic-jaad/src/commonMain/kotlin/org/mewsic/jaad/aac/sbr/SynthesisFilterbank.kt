...
import org.mewsic.jaad.aac.sbr.FilterbankTable.Companion.qmf_c

class SynthesisFilterbank(private val channels: Int) : FilterbankTable {
    ...
    fun sbr_qmf_synthesis_32(
        sbr: SBR, X: Array<Array<FloatArray>>,
        output: FloatArray
    ) {
