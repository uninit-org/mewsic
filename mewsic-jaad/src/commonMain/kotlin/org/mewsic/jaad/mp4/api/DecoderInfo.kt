...
abstract class DecoderInfo {
    fun parse(css: org.mewsic.jaad.mp4.boxes.impl.sampleentries.codec.CodecSpecificBox): DecoderInfo {
        val l: Long = css.type
        val info: DecoderInfo
        when (l) {
            BoxTypes.H263_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.H263DecoderInfo(css)

            BoxTypes.AMR_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.AMRDecoderInfo(css)

            BoxTypes.EVRC_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.EVRCDecoderInfo(css)

            BoxTypes.QCELP_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.QCELPDecoderInfo(css)

            BoxTypes.SMV_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.SMVDecoderInfo(css)

            BoxTypes.AVC_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.AVCDecoderInfo(css)

            BoxTypes.AC3_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.AC3DecoderInfo(css)

            BoxTypes.EAC3_SPECIFIC_BOX -> info =
                org.mewsic.jaad.mp4.api.codec.EAC3DecoderInfo(css)
