...
internal object TFGrid : net.sourceforge.jaad.aac.sbr.Constants {
    /* function constructs new time border vector */ /* first build into temp vector to be able to use previous vector on error */
    fun envelope_time_border_vector(sbr: net.sourceforge.jaad.aac.sbr.SBR, ch: Int): Int {
        var l: Int
        var border: Int
        val temp: Int
    ...
    fun noise_floor_time_border_vector(sbr: net.sourceforge.jaad.aac.sbr.SBR, ch: Int) {
    ...
    private fun middleBorder(sbr: net.sourceforge.jaad.aac.sbr.SBR, ch: Int): Int {
        var retval = 0
        when (sbr.bs_frame_class.get(ch)) {
