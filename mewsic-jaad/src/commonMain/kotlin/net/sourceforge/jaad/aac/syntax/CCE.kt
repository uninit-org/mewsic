...
internal class CCE(frameLength: Int) : net.sourceforge.jaad.aac.syntax.Element(), net.sourceforge.jaad.aac.syntax.Constants {
    private val ics: net.sourceforge.jaad.aac.syntax.ICStream
    ...
    init {
        ics = net.sourceforge.jaad.aac.syntax.ICStream(frameLength)
    ...
    fun decode(`in`: BitStream, conf: DecoderConfig?) {
        ...
        val info: net.sourceforge.jaad.aac.syntax.ICSInfo = ics.info
