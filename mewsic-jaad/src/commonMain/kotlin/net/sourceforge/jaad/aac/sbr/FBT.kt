...
internal object FBT : net.sourceforge.jaad.aac.sbr.Constants {
    ...
    fun master_frequency_table_fs0(
        sbr: net.sourceforge.jaad.aac.sbr.SBR, k0: Int, k2: Int,
    ...
    fun derived_frequency_table(
        sbr: net.sourceforge.jaad.aac.sbr.SBR, bs_xover_band: Int,
        k2: Int
    ): Int {
        var k: Int
        var i = 0
    ...
    fun limiter_frequency_table(sbr: net.sourceforge.jaad.aac.sbr.SBR) {
        var k: Int
        var s: Int
        var nrLim: Int
