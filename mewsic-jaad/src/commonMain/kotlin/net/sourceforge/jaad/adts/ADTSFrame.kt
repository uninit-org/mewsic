...
import net.sourceforge.jaad.aac.ChannelConfigurationimport

net.sourceforge.jaad.aac.SampleFrequency.Companion.forInt
internal class ADTSFrame(`in`: java.io.DataInputStream) {
    //fixed
    ...
    //error check
    private val rawDataBlockPosition: IntArray
    ...
    private fun readHeader(`in`: java.io.DataInputStream) {
        //fixed header:
        ...
        i = i shl 16 or `in`.readUnsignedShort()
    ...
    val channelCount: Int
        get() = ChannelConfiguration.forInt(channelConfiguration).getChannelCount()
}
