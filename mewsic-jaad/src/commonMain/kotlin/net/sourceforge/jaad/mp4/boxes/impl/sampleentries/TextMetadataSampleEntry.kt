...
class TextMetadataSampleEntry :
    net.sourceforge.jaad.mp4.boxes.impl.sampleentries.MetadataSampleEntry("Text Metadata Sample Entry") {
    /**
    ...
    override fun decode(`in`: MP4InputStream) {
        super.decode(`in`)
        mimeType = `in`.readUTFString(getLeft(`in`) as Int, MP4InputStream.UTF8)
    }
}
