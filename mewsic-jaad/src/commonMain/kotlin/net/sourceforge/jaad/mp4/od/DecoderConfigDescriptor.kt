...
/**
 * The `DecoderConfigDescriptor` provides information about the
 ...
 * @author in-somnia
 */
class DecoderConfigDescriptor : net.sourceforge.jaad.mp4.od.Descriptor() {
    /**
